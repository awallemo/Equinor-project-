...
import FanLengthvsWidth from "../components/domain/FanCharts/LengthvsWidth"
 ...
 const Fan_LengthvsWidth = (props) => {
    ...
    return (
      <div className="Wrapper" tabIndex="0">
        ...
        <body>
           <FanLengthvsWidth></FanLengthvsWidth>
        </body>
...
export default Fan_LengthvsWidth;

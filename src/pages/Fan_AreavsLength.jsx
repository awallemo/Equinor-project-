...
import FanAreavsLength from "../components/domain/FanCharts/AreavsLength"
 ...
 const Fan_AreavsLength = (props) => {
    ...
    return (
      <div className="Wrapper" tabIndex="0">
        ...
        <body>
           <FanAreavsLength></FanAreavsLength>
        </body>
...
export default Fan_AreavsLength;

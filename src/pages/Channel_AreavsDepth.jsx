...
import ChannelAreavsDepth from "../components/domain/ChannelCharts/AreavsDepth"
...
const RIGHT_CHOICES = {
 ...
 const Channel_AreavsDepth = (props) => {
    ...
    return (
      <div className="Wrapper" tabIndex="0">
        ...
        <body>
           <ChannelAreavsDepth></ChannelAreavsDepth>
        </body>
...
export default Channel_AreavsDepth;

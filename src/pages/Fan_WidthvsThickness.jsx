...
import FanWidthvsThickness from "../components/domain/FanCharts/WidthvsThickness"
...
const RIGHT_CHOICES = {
 ...
 const Fan_WidthvsThickness = (props) => {
    ...
    return (
      <div className="Wrapper" tabIndex="0">
        ...
        <body>
           <FanWidthvsThickness></FanWidthvsThickness>
        </body>
...
export default Fan_WidthvsThickness;

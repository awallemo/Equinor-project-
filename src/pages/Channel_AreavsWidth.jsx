...
import ChannelAreavsWidth from "../components/domain/ChannelCharts/AreavsWidth"
...
const RIGHT_CHOICES = {
 ...
 const Channel_AreavsWidth = (props) => {
    ...
    return (
      <div className="Wrapper" tabIndex="0">
        ...
        <body>
           <ChannelAreavsWidth></ChannelAreavsWidth>
        </body>
...
export default Channel_AreavsWidth;

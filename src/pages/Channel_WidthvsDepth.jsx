...
import ChannelWidthvsDepth from "../components/domain/ChannelCharts/WidthvsDepth"
...
const RIGHT_CHOICES = {
 ...
 const Channel_WidthvsDepth = (props) => {
    ...
    return (
      <div className="Wrapper" tabIndex="0">
        ...
        <body>
           <ChannelWidthvsDepth></ChannelWidthvsDepth>
        </body>
...
export default Channel_WidthvsDepth;

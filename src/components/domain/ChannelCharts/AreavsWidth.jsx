...
class ChannelAreavsWidth extends React.Component {
  constructor(props) {
    super(props);
    this.state = {    
      data: null,
  ...
  loadData() {
    ...
    parseCsvToJson("./datasets/Channels/Channel_AreavsWidth.csv", (data)=>{
  ...
  render() {
    return (
      <div className="Charts" style={{textAlign:"center"}}>
        <Typography className="Header" variant="h1">Channel deposits Area VS Width </Typography>
...
export default ChannelAreavsWidth;
...
class MTDThicknessvsVolume extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      isAttached:false,    
  ...
  loadData() {
    ...
    parseCsvToJson("./datasets/MTDs/ThicknessvsVolume.csv", (data)=>{
  ...
  render() {
    return (
      <div className="Charts" style= {{textAlign:"center"}}>
        <Typography className="Header" variant="h1">Mass-transport deposit Thickness VS Volume </Typography>
...
export default MTDThicknessvsVolume;
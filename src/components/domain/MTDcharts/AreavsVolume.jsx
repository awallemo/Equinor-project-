...
class MTDAreavsVolume extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      isAttached:false,    
  ...
  loadData() {
    ...
    parseCsvToJson("./datasets/MTDs/AreavsVolume.csv", (data)=>{
  ...
  render() {
    return (
      <div className="Charts" style= {{textAlign:"center"}}>
        <Typography className="Header" variant="h1">Mass-transport deposit Area VS Volume </Typography>

...
export default class FanChart extends PureComponent {
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <Scatter name={this.props.data[0]["plot_types"][1] }  dataKey="y_axis_a" fill="#2F4F4F"/>
        <Scatter name={this.props.data[0]["plot_types"][0] }  dataKey="y_axis_d" fill="#778899"/>

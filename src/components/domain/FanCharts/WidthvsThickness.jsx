...
class FanWidthvsThickness extends React.Component {
  constructor(props) {
    super(props);
    this.state = {    
      data: null,
  ...
  loadData() {
    ...
    parseCsvToJson("./datasets/Fans/Fan_WidthvsThick.csv", (data)=>{
  ...
  render() {
    return (
      <div className="Charts" style={{textAlign:"center"}}>
        <Typography className="Header" variant="h1">Fan deposits Width VS Thickness </Typography>
...
export default FanWidthvsThickness;
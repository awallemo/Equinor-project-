...
class FanAreavsLength extends React.Component {
  constructor(props) {
    super(props);
    this.state = {    
      data: null,
  ...
  loadData() {
    ...
    parseCsvToJson("./datasets/Fans/Fan_AreavsLength.csv", (data)=>{
  ...
  render() {
    return (
      <div className="Charts" style={{textAlign:"center"}}>
        <Typography className="Header" variant="h1">Fan deposits Area VS Length </Typography>
...
export default FanAreavsLength;